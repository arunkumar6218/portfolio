...
const SKILLS = [
  ...
  { name: "Postgre", logo: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/postgresql/postgresql-original.svg" },
  ...
  { name: "VS Code", logo: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/numpy/numpy-original.svg"},
...
const ROWS = [
  [
    { title: "Programming Language", items: ["Python"] },
    { title: "Web Technologies", items: ["HTML", "CSS", "JavaScript", "React"] },
    { title: "Databases", items: ["MySQL","PostgreSQL", "Django", "Git"] },
    { title: "Frameworks & Libraries", items: ["Bootstrap", "Pandas", "Numpy", "Lucide react","Tkinter", "Framer motion"] },
  ],
  [
    {
      title: "Tools",
